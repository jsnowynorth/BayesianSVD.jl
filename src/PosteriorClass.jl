...
function Posterior(data::MaternData, U_post, UZ_post, V_post, VZ_post, D_post, σ_post, σU_post, σV_post, ρ_post, ν_post)
    ...
    MaternPosterior(U_post, UZ_post, V_post, VZ_post, D_post, σ_post, σU_post, σV_post, ρ_post, ν_post,
        U_hat, UZ_hat, V_hat, VZ_hat, D_hat, σ_hat, σU_hat, σV_hat, ρ_hat, ν_hat,
        U_lower, U_upper, V_lower, V_upper, D_lower, D_upper)
    # MaternPosterior(Ubar, UZ_post, Vbar, VZ_post, D_corr, σ_post, σU_post, σV_post, ρ_post, ν_post,
    #     U_hat, UZ_hat, V_hat, VZ_hat, D_hat, σ_hat, σU_hat, σV_hat, ρ_hat, ν_hat,
    #     U_lower, U_upper, V_lower, V_upper, D_lower, D_upper)
