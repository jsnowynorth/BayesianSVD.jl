...
# save("/Users/JSNorth/Documents/Presentations/LBLMLGroup/generatedData1D.png", g)


CairoMakie.contourf(t, x, Z', colormap = :balance, colorrange = crange, levels = range(crange[1], crange[2], step = (crange[2]-crange[1])/nsteps))
...
g = Plots.plot!(x, (svd(Z).U[:,1:k]' .* [1, -1, 1, -1, -1])', c = [:blue :red :magenta :orange :green], linewidth = 2, linestyle = :dash, legend = false)
# save("/Users/JSNorth/Documents/Presentations/LBLMLGroup/Uplot.png", g)

g = Plots.plot(t, V, c = [:blue :red :magenta :orange :green], linewidth = 2, legend = false, size = (700, 400))
g = Plots.plot!(t, (svd(Z).V[:,1:k]' .* [1, -1, 1, -1, -1])', c = [:blue :red :magenta :orange :green], linewidth = 2, linestyle = :dash, legend = false)
# save("/Users/JSNorth/Documents/Presentations/LBLMLGroup/Vplot.png", g)
